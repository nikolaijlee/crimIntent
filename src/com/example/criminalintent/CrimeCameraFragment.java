...
public class CrimeCameraFragment extends Fragment {
	...
	public static final String EXTRA_PHOTO_FILENAME = "com.bignerdrance.android.criminalintent.photo_filename";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup parent,
		...
		// deprecated but required for previous 3.0 devices
		...
		holder.addCallback(new SurfaceHolder.Callback() {
			...
			public void surfaceChanged(SurfaceHolder holder, int format,
				...
				// The surface has changed update the camera preview size
